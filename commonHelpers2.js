import{r as n,b as y,a as m,c as x,p as E}from"./assets/favorites-695bf1c4.js";/* empty css                      */import{P as b,d as w,e as C,i as l}from"./assets/vendor-5fe488fb.js";const h=(e,s,r)=>{const t=document.getElementById("tui-pagination-container"),o=s<5?s:5,a={totalItems:e*s,itemsPerPage:e,visiblePages:o,centerAlign:!0,page:r},i=new b(t,a);return o<=1?t.style.display="none":t.style.display="block",i},f=({targetElement:e,width:s,height:r,disableScroll:t=!1}={})=>{const o=e||document.body,a=document.createElement("div");a.classList.add("loader-container");const i=document.createElement("div");return i.classList.add("loader"),i.style.width=s||"100px",i.style.height=r||"100px",{setLoader:()=>{t&&w(document.body),a.appendChild(i),o.appendChild(a)},deleteLoader:()=>{o.removeChild(a),t&&C(document.body)}}};n.exSearch.addEventListener("input",L);n.exSearch.addEventListener("keydown",S);function L(e){e.target.value===""?n.exSearchImg.classList.remove("is-hidden"):n.exSearchImg.classList.add("is-hidden"),e.inputType===void 0&&u()}function S(e){const s=e.target.value;e.code==="Enter"&&u(s)}function T(){return window.innerWidth<768?8:10}async function u(e="",s=1){const r=await JSON.parse(sessionStorage.getItem("category"));if(!r){const i={title:"Error",message:"Oops, not active category",position:"topRight",color:"red"};return l.show(i)}e&&(r.keyword=e);const t=T(),{setLoader:o,deleteLoader:a}=f({disableScroll:!0});try{o();const i=await y({page:s,perPage:t,filter:r});h(t,i.totalPages,s).on("afterMove",({page:d})=>{u(e,d),n.divCategoriesContainer.scrollIntoView()});let c="";i.results.length?(c=M(i.results),n.divCategories.classList.remove("exercises-list-bed-requast"),n.divCategories.classList.add("exercises-list")):(c=`<li><div class='categories-bad-requast'>
