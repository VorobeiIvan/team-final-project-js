import{b as y,r as n,a as m,c as E,p as x}from"./assets/favorites-a97a7640.js";/* empty css                      */import{P as b,d as w,e as C,i as l}from"./assets/vendor-5fe488fb.js";const h=(e,s,i)=>{const t=document.getElementById("tui-pagination-container"),o=s<5?s:5,a={totalItems:e*s,itemsPerPage:e,visiblePages:o,centerAlign:!0,page:i},r=new b(t,a);return o<=1?t.style.display="none":t.style.display="block",r},f=({targetElement:e,width:s,height:i,disableScroll:t=!1}={})=>{const o=e||document.body,a=document.createElement("div");a.classList.add("loader-container");const r=document.createElement("div");return r.classList.add("loader"),r.style.width=s||"100px",r.style.height=i||"100px",{setLoader:()=>{t&&w(document.body),a.appendChild(r),o.appendChild(a)},deleteLoader:()=>{o.removeChild(a),t&&C(document.body)}}};document.querySelector(".exercises-search-wrapper input").addEventListener("keydown",L);function L(e){const s=e.target.value;(e.keyCode===13||e.code==="Enter")&&u(s)}function T(){return window.innerWidth<768?8:10}async function u(e="",s=1){const i=await JSON.parse(sessionStorage.getItem("category"));if(!i){const r={title:"Error",message:"Oops, not active category",position:"topRight",color:"red"};return l.show(r)}e&&(i.keyword=e);const t=T(),{setLoader:o,deleteLoader:a}=f({disableScroll:!0});try{o();const r=await y({page:s,perPage:t,filter:i});h(t,r.totalPages,s).on("afterMove",({page:d})=>{u(e,d),n.divCategoriesContainer.scrollIntoView()});let c="";r.results.length?(c=M(r.results),n.divCategories.classList.add("exercises-list")):(c=`<li><div class='categories-bad-requast'>
